  ...
  for (int i = 0; i < 2; i++) {
    ...
    switch (temp) {
      case 0:  //home
        ...
        lcd.drawRect(430, 11, 38, 38);
        break;
      case 1:  //Hold
        lcd.drawRect(387, 230, 70, 70);
        lcd.drawRect(388, 231, 68, 68);
        break;
      case 2:  //Zero
        lcd.drawRect(296, 230, 70, 70);
        lcd.drawRect(297, 231, 68, 68);
        break;
      case 3:  //On/Off Motor
        lcd.drawRect(205, 230, 70, 70);
        lcd.drawRect(206, 231, 68, 68);
        break;
      case 4:  //UM
        lcd.drawRect(114, 230, 70, 70);
        lcd.drawRect(115, 231, 68, 68);
        break;
      case 5:  //EB
        lcd.drawRect(23, 230, 70, 70);
        lcd.drawRect(24, 231, 68, 68);
        break;
...
//Funzione per il cambio di grafica dei diversi stati del motore
